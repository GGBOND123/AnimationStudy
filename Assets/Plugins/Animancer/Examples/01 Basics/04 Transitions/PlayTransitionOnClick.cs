...
namespace Animancer.Examples.Basics
{
    ...
    public sealed class PlayTransitionOnClick : MonoBehaviour
    {
        ...
        {
            Debug.Log("结束结束！！！！！！！！！" + _Animancer.States[_Action].NormalizedTime);
            Debug.Log("结束结束！！！！！！！！！" + _Animancer.States[_Action].Weight);
            //_Animancer.Play(_Idle);
        ...
        private void Update()
        {
            ...
            Debug.Log("时间：" + _Animancer.States[_Action].NormalizedTime);
            Debug.Log("权重：" + _Animancer.States[_Action].Weight);
        }
